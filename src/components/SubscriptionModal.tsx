...
export function SubscriptionModal({ isOpen, onClose, onSubscribe, isAuthenticated, userEmail }: SubscriptionModalProps) {
          ...
          <div className="bg-gray-950 border border-gray-900 rounded-[6px] p-[20px] mb-[24px]">
            {isAuthenticated ? (
              ...
              <>
                ...
                {error && (
                  <div className="text-red-400 text-[12px] mb-[12px] text-center">{error}</div>
                )}
